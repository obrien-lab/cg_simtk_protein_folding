        ...
        for stage in range(3):
            ...
            for traj_name in TS[chain_length-1][stage][0]:
                if traj_name.endswith('.cor'):
                    ...
                    os.system('calc_entanglement_number_v2.pl -i '+ref_cor+' -t '+tmp_dir+'/traj.cor > /dev/null')
                else:
                    if os.path.exists(traj_name):
                        if not os.path.getsize(traj_name):
                    ...
                    os.system('calc_entanglement_number_v2.pl -i '+ref_cor+' -t '+tmp_dir+'/traj.dcd > /dev/null')
