...
mol representation QuickSurf 2.000000 1.500000 1.000000 3.000000
...
if { $stage_idx != 4 } { 
  ...
  mol color ColorID 8
  mol selection "not segname A L24 AtR PtR and x<58"
  mol material YangTrans1
  mol addrep top

  mol representation QuickSurf 3.000000 2.000000 1.000000 3.000000
  mol color ColorID 8
  mol selection "not segname A L24 AtR PtR and (x>=58 and y<20 and y>-20 and z>-15)"
  mol material YangTrans1
  mol addrep top
