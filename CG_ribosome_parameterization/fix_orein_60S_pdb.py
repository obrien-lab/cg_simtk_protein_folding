...
usage = '\nUsage: python fix_orein_60S_pdb.py\n' \
...
print('--> Translate new pdb as 25S A2971 N6 at origin')
idx_1 = 0
idx_2 = 0
for atm in new_pdb_struct.atoms:
	if atm.residue.segid == '25S' and atm.residue.number == 2971 and atm.name == 'N6':
		idx_1 = atm.idx
	elif atm.residue.segid == 'L26' and atm.residue.number == 91 and atm.name == 'N':
		idx_2 = atm.idx
...
print('    rotate coor to make vector from 25S:2971@N6 to L26:91@N along x-axis')
