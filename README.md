...
- Scripts will be used in this section:
  ...
  - CG_protein_parameterization/**parallel_temperature_REX.py**
    ...
    Run parallel temperature replica exchange molecular dynamics (pt-REMD) simulation. This simulation is parallelized using multiple CPU processors. ([Learn more](../../wiki/help_wiki/parallel_temperature_REX))
