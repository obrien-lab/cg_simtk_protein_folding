...
| Analysis_protocol/**calc_entanglement_number_v2.pl** | Updated script to calculate ![equation](https://latex.codecogs.com/svg.image?\inline&space;G) vs. time for a given trajectory. ([Learn more](../../wiki/calc_entanglement_number_v2.pl)) | 
...
| Analysis_protocol/**calc_cont_synth_G_vs_T_v2.py** | Updated script to calculate ![equation](https://latex.codecogs.com/svg.image?\inline&space;G) vs. time for [CSP](#4-simulation-of-co-translational-folding) trajectoris. ([Learn more](../../wiki/calc_cont_synth_G_vs_T_2.py)) <br>Scripts needed: `Analysis_protocol/calc_entanglement_number_v2.pl` |
